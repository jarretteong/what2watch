...
import { fetchTMDBMovieCredits, fetchTMDBMovieImages, fetchTMDBMovieVideos, fetchTMDBMoviesByGenreId } from "@/app/utils/tmdbApi";
...
const handler = async (req: NextApiRequest, res: NextApiResponse<GenreMovieData>) => {
    if (req.query.id) {
        const genreId =
